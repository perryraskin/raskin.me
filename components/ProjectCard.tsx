        ...
        <article className="flex flex-col items-start justify-between h-full p-6 bg-white rounded-lg shadow dark:bg-neutral-700">
          ...
          <div className="flex items-center justify-between w-full mt-2">
            <button
              ...
              ${
                language === "JavaScript"
                  ? " bg-yellow-100 text-yellow-600 dark:bg-yellow-500 "
                  : ""
              }
              ${
                language === "TypeScript"
                  ? " bg-indigo-100 text-indigo-600 dark:bg-indigo-500 "
                  : ""
              }
              ${
                language === "Java"
              ...
              ${
                language === "Jupyter Notebook"
                  ? " bg-orange-100 text-orange-600 dark:bg-orange-500 "
                  : ""
              }
              ${
                language === "Python"
            ...
            <span className="my-auto text-sm font-semibold">
              <a
                href={homepage}
                className={
                  homepage === "" ? `invisible` : `hover:text-blue-500`
                }
              >
                <NextOcticon name="link" size="small" />
              </a>
              &nbsp;&nbsp;&nbsp;&nbsp;
