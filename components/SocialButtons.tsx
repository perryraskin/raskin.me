...
const SocialButtons: NextPage<SocialButtonsProps> = ({
  frontmatter,
  extend,
}) => {
  return (
    <div className={extend}>
      ...
      &nbsp;
      <TwitterShareButton title={frontmatter.title} url={frontmatter.url}>
        <TwitterIcon size={32} round={true} path="" />
      </TwitterShareButton>
      &nbsp;
      <FacebookShareButton quote={frontmatter.title} url={frontmatter.url}>
      ...
      &nbsp;
      <RedditShareButton title={frontmatter.title} url={frontmatter.url}>
        <RedditIcon size={32} round={true} path="" />
      </RedditShareButton>
      &nbsp;
      <TelegramShareButton title={frontmatter.title} url={frontmatter.url}>
